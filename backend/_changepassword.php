...
<?php
 ...
 if($currentpassword && $newpassword && $confirmnewpassword && $email && $phone && $name){
    if($newpassword !== $confirmnewpassword){
        ...
        if(mysqli_num_rows($result)>0){
            ...
            if(password_verify($currentpassword,$row['password'])){
                $sql ="UPDATE `merohostel_users` SET `merohostel_users`.`password`='$Passwordhash' WHERE `email`='$email' AND `phone`='$phone';";
                                      ...
                                      <tr>
                                        <td class="content-cell">
                                          <div class="f-fallback">
                                            <h1>Hi '.$name.',</h1>
                                            <p><strong>You recently change your password for your Mero Hostel account.</strong></p>
                                            <!-- Action -->
                                            <table class="body-action" align="center" width="100%" cellpadding="0" cellspacing="0" role="presentation"></table>
                                            <p>If you did not change your password, please report to <a href="#">Mero Hostel Team</a>.</p>
                ...
                echo "Password Can't be changed due to some error.";
            }
        }
    }
